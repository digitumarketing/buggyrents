...
export const library: Record<string, { subject: Subject; alt: string; seats?: Seats; make?: Make }> = {
  ...
  'canam-maverick-r-4-seater-teal-dune-buggy-dubai': { subject: 'buggy', seats: 4, make: 'canam', alt: 'Teal Can-Am Maverick R X RS four seater dune buggy on Dubai desert sand' },
  'canam-maverick-x3-4-seater-black-red-dubai-red-dunes': { subject: 'buggy', seats: 4, make: 'canam', alt: 'Black and red Can-Am Maverick X3 four seater dune buggy on the Dubai red dunes' },
  'canam-maverick-x3-4-seater-blue-red-dune-dubai': { subject: 'buggy', seats: 4, make: 'canam', alt: 'Blue Can-Am Maverick X3 four seater dune buggy parked on a Dubai red dune' },
  'canam-maverick-x3-4-seater-gold-sand-spray-dubai': { subject: 'buggy', seats: 4, make: 'canam', alt: 'Four riders in a gold Can-Am Maverick X3 four seater dune buggy throwing up sand in Dubai' },
  'canam-maverick-x3-4-seater-tan-guided-tour-dubai': { subject: 'buggy', seats: 4, make: 'canam', alt: 'Couple in a tan Can-Am Maverick X3 four seater dune buggy on a guided Dubai desert tour' },
...
export const heroes: Record<string, { subject: Subject; focal: 'left'|'center'|'right'; w: number; h: number; alt: string; seats?: Seats; make?: Make }> = {
  ...
  'canam-maverick-r-4-seater-hero-blue-dubai-dunes': { subject: 'buggy', seats: 4, make: 'canam', focal: 'right', w: 1600, h: 1067, alt: 'Guests riding a blue Can-Am Maverick R X RS four seater dune buggy up a Dubai dune' },
