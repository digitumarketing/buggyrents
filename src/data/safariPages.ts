...
export const safariPages: SafariPageDef[] = [
  ...
  /* --------------------------------------------------------------- quad / atv */
  {
    ...
    faqs: [
      ...
      { q: 'Can I book a quad tour and a safari separately instead?', a: 'Yes, and for anyone who mainly wants to ride, that is the better answer. A quad and safari combination starts at AED 199 for a 30 minute ride and AED 300 for an hour, which buys far more saddle time than the camp session does.' },
    ...
    guideBlocks: [
      ...
      { h: 'When to book the quad separately instead', html: `<p>If the riding is the reason you are going to the desert, book <a href="/quad-bike-dubai/">quad bike rental Dubai</a> on its own and treat the safari as the add-on rather than the other way round. Routes run from 30 minutes to 4 hours, the open desert tiers leave the fenced area entirely, and the machines go up to a Yamaha Raptor 700cc.</p><p>The combination pricing makes this easy: a quad with a safari starts at AED 199 for a 30 minute ride and AED 300 for an hour. That is a small step up from the bundled packages and it buys a completely different amount of time on the machine.</p>` },
