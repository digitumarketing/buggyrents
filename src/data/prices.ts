...
export const buggyPrices: PriceGuideData = {
  ...
  specs: [
    ...
    { label: 'Durations', value: '30 min to 2 hr' },
  ...
  guideBlocks: [
    ...
    { h: 'Polaris or Can-Am?', html: `<p class="lf-lead">The price ladder tracks power and suspension, not service quality.</p><p>The <a href="/dune-buggy-dubai/polaris-rzr-1000-2-seater/">Polaris RZR 1000</a> starts at AED 300 and is the balanced first-time choice: stable, forgiving, easy to place on a dune face. The <a href="/dune-buggy-dubai/can-am-maverick-x3-2-seater/">Can-Am Maverick X3</a> at AED 550 is a serious step up in acceleration and travel.</p><p>Above that, the Turbo RR and <a href="/dune-buggy-dubai/can-am-maverick-r-turbo/">Maverick R</a> are for drivers with real off-road experience. Paying more does not make the ride easier; it makes it faster and less forgiving.</p>` },
    { h: 'Which duration is worth paying for', html: `<p class="lf-lead">Thirty minutes is a taster. An hour is where most people should land.</p><p>The jump from 30 minutes to an hour roughly doubles the price but more than doubles the experience, because the briefing and warm-up eat into a short slot. On a 30-minute booking you are only properly riding for about 20 minutes.</p><p>Two hours is the longest buggy slot we run, and it suits experienced drivers and groups pairing the ride with a camp stop. If you are travelling in from outside Dubai, book at least an hour.</p>` },
